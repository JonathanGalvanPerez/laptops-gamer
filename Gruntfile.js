module.exports = function (grunt){
	...
	grunt.initConfig({
		...
		browserSync: {
			...
			options: {
				watchTask: true,
				server: {
					//Directorio base para nuestro servidor
					baseDir: './'
				}
			}
		},
		...
		clean: {
			build: {
				src: ['dist/'] //Limpia la carpeta dist
			}
		},
		...
		useminPrepare: {
			foo: {
				dest: 'dist',
				src: ['index.html', 'about.html', 'productos.html', 'contacto.html']
			},
			options: {
				flow: {
					steps: {
		...
		usemin: {
			html: ['dist/index.html', 'dist/about.html', 'dist/productos.html', 'dist/contacto.html'],
			options: {
	...
	grunt.registerTask('build', [
		...
		'useminPrepare', //Preramos la configuracion de usemin
		'concat',
		'cssmin',
		'uglify',
